...
class PapyrusSettings < RailsSettings::Base
  ...
  field :worldcat_key, default: (ENV['worldcat_key'] || 'iyourkeyhere')
  ...
  field :primo_apikey, default: (ENV['primo_apikey'] || 'yourkey')
  ...
  field :alma_apikey, default: (ENV['alma_apikey'] || 'apikeyhere')
