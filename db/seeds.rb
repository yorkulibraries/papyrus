...
if PapyrusSettings.count == 0
  PapyrusSettings.create!([
                            ...
                            { var: 'course_code_sample', value: '2011_AP_ADMS_F_1000__3_A', thing_id: nil,
                              thing_type: nil },
                            { var: 'course_lookup_url', value: 'http://coursecode.yorku.ca', thing_id: nil,
                              thing_type: nil },
                            ...
                            { var: 'auth_cas_user_id_label', value: 'Same as Student Number', thing_id: nil,
                              thing_type: nil },
                            { var: 'auth_cas_logout_redirect', value: 'https://www.library.yorku.ca', thing_id: nil,
                              thing_type: nil },
                            { var: 'auth_cookies_domain', value: 'yorku.ca', thing_id: nil, thing_type: nil },
                            { var: 'errors_email_subject_prefix', value: '[Papyrus Error]', thing_id: nil,
                              thing_type: nil },
                            { var: 'errors_email_from', value: "'Papyrus Notifier' <papyrus@mailinator.com>",
                            ...
                            { var: 'email_from', value: 'papyrus@mailinator.com', thing_id: nil, thing_type: nil },
                            { var: 'email_welcome_subject', value: 'Welcome to Transcription Services', thing_id: nil,
                              thing_type: nil },
                            { var: 'email_welcome_body',
                            ...
                            { var: 'email_item_assigned_subject', value: 'Multiple item(s) have now been assigned to you', thing_id: nil,
                              thing_type: nil },
                            { var: 'email_item_assigned_body',
                            ...
                            { var: 'email_acquisitions_to', value: 'acquisition@me.ca', thing_id: nil,
                              thing_type: nil },
                            { var: 'email_acquisitions_to_bookstore', value: 'bookstore@me.ca', thing_id: nil,
                              thing_type: nil },
                            ...
                            { var: 'course_listing_header', value: 'HTTP_PYORK_COURSES', thing_id: nil,
                              thing_type: nil },
                            ...
                            { var: 'import_send_welcome_email_to_student', value: 'true', thing_id: nil,
                              thing_type: nil },
                            ...
                            { var: 'email_lab_access_subject', value: 'Lab Access Only Subject', thing_id: nil,
                              thing_type: nil },
                            { var: 'email_lab_access_body', value: 'Lab Access Only Body', thing_id: nil,
                              thing_type: nil },
                            ...
                            { var: 'primo_region', value: 'https://api-na.hosted.exlibrisgroup.com', thing_id: nil,
                              thing_type: nil },
