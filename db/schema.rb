...
ActiveRecord::Schema[7.0].define(version: 2022_06_30_182701) do
  create_table "access_codes", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "for"
    t.string "code"
    t.date "expires_at"
  ...
  create_table "appointments", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "student_id"
    t.string "title"
    t.integer "user_id"
  ...
  create_table "item_connections", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "item_id"
    t.integer "student_id"
    t.date "expires_on"
    t.datetime "created_at", precision: nil
  ...
  create_table "item_course_connections", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "item_id"
    t.integer "course_id"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "student_details", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "student_id"
  ...
  create_table "terms", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.date "start_date"
    t.date "end_date"
    t.datetime "created_at", precision: nil
  ...
  create_table "todo_items", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "summary"
    t.integer "item_id"
    t.integer "todo_list_id"
    t.integer "assigned_to_id"
  ...
  create_table "todo_lists", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.integer "created_by_id"
    t.integer "assigned_to_id"
    t.string "status"
