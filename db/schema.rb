...
ActiveRecord::Schema[7.0].define(version: 20_220_630_182_701) do
  ...
  create_table 'attachments', force: :cascade do |t|
    ...
    t.index %w[item_id deleted], name: 'index_attachments_on_item_id_and_deleted'
  end
  ...
  create_table 'item_connections', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[expires_on item_id], name: 'ic_e_i_index'
    t.index %w[expires_on student_id], name: 'ic_e_s_index'
    t.index %w[student_id item_id expires_on], name: 'ic_s_i_e_index'
  end
  ...
  create_table 'item_course_connections', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[course_id item_id], name: 'icc_c_i_index'
  end
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w[inactive role], name: 'index_users_on_inactive_and_role'
    t.index ['inactive'], name: 'index_users_on_inactive'
    t.index %w[type inactive], name: 'index_users_on_type_and_inactive'
