...
class SettingsControllerTest < ActionController::TestCase
  ...
  should "update settings upon submission" do
    ...
    put :update, papyrus_settings: { app_name: "papyrus" }
  ...
  should "redirect to proper page" do
    put :update, papyrus_settings: { app_name: "papyrus" }, return_to: "item"
    assert_redirected_to item_settings_path

    put :update, papyrus_settings: { app_name: "papyrus" }, return_to: "bib_search"
    assert_redirected_to bib_search_settings_path

    put :update, papyrus_settings: { app_name: "papyrus" }, return_to: "email"
    assert_redirected_to email_settings_path

    put :update, papyrus_settings: { app_name: "papyrus" }, return_to: "system"
    assert_redirected_to system_settings_path

    put :update, papyrus_settings: { app_name: "papyrus" }, return_to: "general"
