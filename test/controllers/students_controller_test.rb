...
class StudentsControllerTest < ActionDispatch::IntegrationTest
    ...
    should 'create a new student' do
      ...
      assert_difference ['Student.count', 'StudentDetails.count'], 1 do
        post students_path, params: {
          student: { first_name: 'dude', last_name: 'test', email: '1@1.com', username: 'dude', password: '12345678', student_details_attributes: student_details }
        }
  ...
  context 'Creating Student with Header authetication' do
    ...
    should 'update an existing student' do
      ...
      details = create(:student_details, student:, student_number: '000')
      ...
      patch student_path(student),
            params: { student: { first_name: 'new', student_details_attributes: student_details } }
    ...
    should 'display student details and only current items, not expired ones' do
      student = create(:student)
      create_list(:item_connection, 3, student:, expires_on: Date.today - 1.year)
      create_list(:item_connection, 6, student:, expires_on: Date.today + 1.year)
