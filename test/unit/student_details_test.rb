...
class StudentDetailsTest < ActiveSupport::TestCase
  ...
  should "not create an invalid student details" do
    ...
    student_details = build(:student_details, preferred_phone: nil, cds_adviser: nil)
  ...
  should "be able to update student details" do
    details = create(:student_details, student_number: 12323, cds_adviser: "some dude", preferred_phone: "393939")
