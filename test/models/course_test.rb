...
class CourseTest < ActiveSupport::TestCase
  ...
  should 'search for courses and ignore courses with expired Terms' do
    ...
    expired_term = create(:term, name: 'expired', start_date: Date.today - 1.year,
    ...
    assert_equal 1, Course.search('same_string').size,
                 "Both courses have 'same_string' in them, but it should only return 1 course"
