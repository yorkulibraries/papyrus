...
class StudentTest < ActiveSupport::TestCase
  ...
  should 'display as current items if expires_on is set to null, or empty' do
    ...
    create_list(:item_connection, 2, student:, expires_on: Date.today - 1.month)
  ...
  should 'show only students assigned to a particular user' do
    ...
    # control student
    create_list(:student_details, 2,  student: create(:student),
                                      transcription_coordinator: create(:user, role: User::STAFF))
  ...
  should 'return a map of student id and current, expired or all item counts' do
    ...
    students.each do |student|
      create_list(:item_connection, 10, expires_on: 1.year.from_now, student:)
  ...
  should 'update fields from array of fields' do
    ...
    data = [12_323, 'Johnny', 'Smithy', 'johnny@smitthy.com', 'Jeremy Irons', 'jeremy@irons.com', '2012-10-10', 'True', 'false', 'True',
    ...
    # student details
    assert_equal 12_323, student_details.student_number, 'Student number should be unchanged'
