...
class StudentsControllerTest < ActionController::TestCase
  ...
  should "create a new student" do
    student_details = { student_number: '123232', cell_phone: '11232', cds_adviser: 'dadf', transcription_coordinator_id: @user.id,
  ...
  should "update an existing student" do
    ...
    student_details = { student_number: '111', cell_phone: '11232', cds_adviser: 'dadf', transcription_coordinator_id: @user.id,
        transcription_assistant_id: @user.id }
